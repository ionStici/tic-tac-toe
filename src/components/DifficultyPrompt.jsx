      ...
      <section className={styles.section}>
        <div className={styles.container}>
          ...
          <div className={styles.button_box}>
            <ButtonSecond color="silver" text="Easy" onClick={props.easyEvent} />
            <ButtonSecond color="silver" text="Normal" onClick={props.normEvent} />
            <ButtonSecond color="silver" text="Hard" onClick={props.hardEvent} />
          </div>
        </div>
      </section>
    </>
